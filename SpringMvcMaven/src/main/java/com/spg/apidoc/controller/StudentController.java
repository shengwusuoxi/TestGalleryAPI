...
public class StudentController extends BaseController
{
    ...
    @RequestMapping(value = "/update/{studentId}", method = RequestMethod.POST, consumes = "application/json")
    public void updateCategory(@PathVariable Long studentId, @RequestBody UserInfo userInfo) {
        //update category
    }   
